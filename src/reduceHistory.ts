...
export type HistoryAction<T> = { type: Operation.PUSH; state: T } | { type: Operation.BACK } | { type: Operation.FORWARD };

function reduce<T>(prevState: HistoryState<T>, action: HistoryAction<T>): HistoryState<T> {
